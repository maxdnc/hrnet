  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-indigo-500 text-indigo-50 hover:bg-indogo-500 hover:text-neutral-50 focus:bg-indigo-500 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900',
        day_today:
