...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b transition-colors hover:bg-indigo-100/50 data-[state=selected]:bg-indigo-100 dark:hover:bg-indigo-800/50 dark:data-[state=selected]:bg-indigo-800',
      className
    )}
    {...props}
  />
